...
import classes from './css/reloadPassword.module.css';
                ...
                <div className={'row'}>
                    ...
                    <div className={'col-12 mt-4 text-center'}>
                        <label className={classes.text}>
                            ...
                            На Ваш email было отправлено письмо.<br/> Следуйте дальнейшим инструкциям для восстановления доступа к аккаунту.
                        </label>
                    </div>
                    <div className={'col-12 text-center mt-3'}>
                        <label className={classes.text}>
                            С уважением команда KenguruExpress.
                        </label>
                    </div>
